...
export default {
    ...
    archivarPartidos() {
      if (this.seleccion.length != 0) {
        const info = {
          ...
          cuerpo:
            "Al confirmar, estos partidos ya no podrán ser modificados y serán eliminados de la interfaz del usuario y el candario de partidos",
  ...
  created: function () {
    if (this.pedidoTer === false) {
      ...
      this.axios
        .get(`/matches/match-estado/TERMINADO`)
        .then((res) => {
