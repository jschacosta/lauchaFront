  ...
  <div>
    <v-row>
      ...
      <v-col cols="4" class="d-flex text-start align-center">
        <v-btn color="primary" dark @click="searchPlayer()"
          >Buscar Jugadores</v-btn
        >
      </v-col>
    </v-row>
  ...
  methods: {
    searchPlayer() {
      if (this.torneos.elecciones === undefined) {
        ...
        this.axios
          .get(`/players/players`, this.torneos.elecciones)
          .then((res) => {
