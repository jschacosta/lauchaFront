                ...
                <v-col cols="12" md="8">
                  <v-card-text class="mt-12">
                    ...
                    <h4 class="text-center mlt-4">
                      Ingresa a tu cuenta con tu correo
                    </h4>
              ...
              <v-row class="fill-height">
                <v-col cols="12" md="4" class="grey darken-4">
                  <v-card-text class="white--text mt-12">
                    ...
                    <h5 class="text-center">Ingresa presionando Sign in</h5>
                  </v-card-text>
                  <div class="text-center">
                ...
                <v-col cols="12" md="8">
                  <v-card-text class="mt-12">
                    <h1 class="text-center display-2 ">Registrate</h1>
                    <div class="text-center mt-4">
                      <v-btn class="mx-2" fab color="black" outlined>
                        <v-icon>fab fa-facebook-f</v-icon>
                      </v-btn>
...
export default {
  ...
  methods: {
    ...
    signIn() {
      ...
      this.axios
        .post("/sign-in", { email: this.Email, password: this.Password1 })
        .then((res) => {
