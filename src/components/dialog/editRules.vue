    ...
    <v-row justify="center">
        <v-dialog v-model="reglasEditadas.estado" persistent max-width="800px">
            <v-card>
                ...
                <v-card-actions>
                    <v-spacer></v-spacer>
                    <v-btn color="green darken-1" text @click="subirReglas(idVacio)">Cancelar</v-btn>
                    <v-btn color="green darken-1" text @click="editReglas()">Añadir Reglas</v-btn>
                </v-card-actions>   
            </v-card>
        </v-dialog>
    </v-row>
...
<script>
    ...
    export default {
        ...
        methods:{
            ...mapMutations('match',['dialogReglas','actualizarReglas','cambiarBotones','subirReglas']),
