    ...
    <v-row>
      ...
      <v-col cols="12" md="10" class="container mt-3">
        <v-card-text class="mt-5 elevation-12">
          <h1 class="text-center black--text titulo my-4">Nueva contraseña</h1>
  ...
  methods: {
    ...
    forgot() {
      if (this.Password1 != this.Password2) {
        ...
        this.axios
          .put(`/users/reset-password/${this.token}`, {
            email: this.email,
          ...
          .then((res) => {
            ...
            this.respuesta =
              "Tu contraseña ha sido actualizada, haz click en volver a Ingreso";
            this.estado = true;
            this.loadingFunction();
